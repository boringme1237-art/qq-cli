...
基于 qq-cli 只读能力扩展的"自动占位回复 + 30 分钟未回复提醒"完整方案，
含 6 阶段复现 prompt、回复风格手册与安全边界说明，见
[docs/auto-reply/](docs/auto-reply/)（真实使用案例的脱敏版）。
该方案会以 GUI 模拟按键在 QQ 窗口发送固定话术，账号风险自担；供个人工作号参考。
